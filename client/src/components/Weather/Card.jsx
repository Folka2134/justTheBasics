...
export const Card = () => {
  return (
    <>
      <li className='bg-[#1D18C7] h-96 w-64 m-6 overflow-hidden rounded-lg'>
        <div className='w-64 p-6 absolute flex justify-between'>
          <p className='bg-[#1D18C7] border-2 border-cyan-400 p-4 rounded-lg'>Icon1</p>
          <p className='bg-[#1D18C7] border-2 border-cyan-400 p-4 rounded-lg'>Icon2</p>
        </div>
